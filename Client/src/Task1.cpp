        ...
        using std::string;
            ...
            Task1::Task1(ConnectionHandler *connectionHandler):connectionHandler(connectionHandler), shouldTerminate(false){}

            Task1::~Task1(){}//Destructor

            Task1:: Task1(const Task1 &other): connectionHandler(other.connectionHandler), shouldTerminate(other.shouldTerminate){}//Copy Constructor

            Task1::Task1(Task1 &&other): connectionHandler(other.connectionHandler), shouldTerminate(other.shouldTerminate){//Move Constructor
